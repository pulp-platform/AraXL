  ...
  always_comb begin: p_vldu
    ...
    if (axi_r_valid_i && axi_addrgen_req_valid_i
      ...
      if (vinsn_issue_valid && (vinsn_issue_q.vm || (|mask_valid_i))) begin
        ...
        if ((vinsn_issue_q.op == VLXE) || (vinsn_issue_q.op == VLSE)) valid_bytes = 1 << vinsn_issue_q.vtype.vsew;
      ...
      if (vinsn_issue_q.op == VLXE || vinsn_issue_q.op == VLSE || r_pnt_d == AxiDataWidth/8 || issue_cnt_d == '0) begin
